            ...
            children: [
              Expanded(
                child: ButtonPiorityComponent(
                  title: 'Bajo',
                  colorBorder: AppColor.color0xFFFACBBA,
                ),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: ButtonPiorityComponent(
                  title: 'Medio',
                  colorBorder: AppColor.color0xFFD7F0FF,
                ),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: ButtonPiorityComponent(
                  title: 'Alto',
                  colorBorder: AppColor.color0xFFFAD9FF,
                ),
              ),
            ],
          ),
